                ...
                <div class="tab-content">
                  <div id="shared-server" class="tab-pane active pr-3 pl-3 pb-3"><br>
                    <table class="table table-borderless mb-5">
                      ...
                      <tbody>
                          <tr class="row mb-3">
                            <td class="col-sm-2"><a href="" class="link-dark text-decoration-none" target="_blank">saisai.test</a>
                            </td>
                            <td class="col-sm-2">
                          ...
                          <tr class="row">
                            <td class="col-sm-2"><a href="" class="link-dark text-decoration-none" target="_blank">saiyannaing1.test</a>
                            </td>
                            <td class="col-sm-2">

                              <a href="/admin/share?webid=<?= $domain['id'] ?>" class="btn btn-info btn-sm btn-border-radius text-light" target="_blank">設定</a>
                            </td>
                            <td class="col-sm-2">
                              <span>0B</span>
                            </td>
                            ...
                            <td class="col-sm-2">
                              <form action="/admin/app_setting/confirm" method = "post">
                                <input type="hidden" name="app" value="app">
                                <input type="hidden" name="domain" value="<?=$domain['domain'] ?>">
                                <input type="checkbox" data-toggle="toggle" data-style="ios" data-onstyle="info" data-offstyle="secondary" data-on="起動" data-off="停止" data-size="sm" name='onoff' onchange="this.form.submit()">
                              </form>
                            </td>
